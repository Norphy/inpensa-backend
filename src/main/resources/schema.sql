...
CONSTRAINT CHK_ROLE CHECK (ROLE IN ('user:read', 'user:write', 'admin:read', 'admin:write', 'superadmin')));
...
-- ALTER T_ROLE TABLE --
--ALTER TABLE T_ROLE
--ADD FOREIGN KEY (CREATED_BY) REFERENCES T_USER(ID); --TODO enable this
