...
public class CategoryRepositoryJdbcImpl implements CategoryRepository {
    ...
    public List<Category> getAllCategories() {
        ...
        final String SQL_GET_ALL_CATEGORIES = "SELECT * FROM T_CATEGORY;";
        return  jdbcTemplate.query(SQL_GET_ALL_CATEGORIES, CATEGORY_ROW_MAPPER);
    }
...
//    }
    ...
    public Category saveCategory(Category category) {
        logger.debug("Save new Category. User id: {}", category.ownerId());
    ...
    public void updateCategory(Category category) {
        ...
        logger.debug("Update Category. Cat id: {} User id: {}", category.id(), category.ownerId());
