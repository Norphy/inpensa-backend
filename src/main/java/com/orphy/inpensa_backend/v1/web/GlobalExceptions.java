package com.orphy.inpensa_backend.v1.web;
...
public class GlobalExceptions {
    ...
    public ResponseEntity<ProblemDetail> handleResourceNotFound(ResourceNotFoundException exception) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN).build();//TODO do we want unauthorized for all not found exceptions?
    }
}
